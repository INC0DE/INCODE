  ...
  return (
    <Section className="overflow-hidden">
      <div className="container relative z-2">
        <h1 className="h3 mb-4 text-n-11">Creating successful websites.</h1>
      ...
      <div className="container relative sm:justify-items-end z-2">
        <h1 className="h3 mb-4 text-n-11">Creating connections.</h1>
        <p className="body-2  text-n-1">
