      ...
      <div className="container relative z-2">
        ...
        <div className="container relative mb-10 z-2">
          ...
          <p className="body-2">
            ...
            It is a static website with hoisting and domain included.
          </p>
        </div>
        ...
        <div className="container relative mb-10 z-2">
          ...
          <p className="body-2">
            ...
            This functional website includes hoisting and domain.
          </p>
        ...
        <div className="container relative mb-5 z-2">
          ...
          <p className="body-2">
            ...
            Contains database of your sales and merchandise as well as hoisting and domain.
          </p>
        </div>
